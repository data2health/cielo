...
class DataControllerSpec extends Specification implements ControllerUnitTest<DataController>, DomainUnitTest<Data> {

    void setup() {
        mockDomains(SoftwareLicense, Project)
        messageSource.addMessage('data.doesNotExist', Locale.getDefault(), "Data does not exist")
    }
    ...
    void "test view"() {
        ...
        when:
            ...
            Data data = new Data(name: "Some name", description: "Some description", repository: "repo", project: project).save()
            params.id = data.id
            controller.view()
