                ...
                <td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:20px 0px;">
                    ...
                    <div class="mj-column-per-100 outlook-group-fix"
                        ...
                        <table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                            <tbody>
                            <tr>
                                <td style="word-wrap:break-word;font-size:0px;padding:10px 25px;padding-top:0px;padding-bottom:20px;"
                                    align="left">
                                    <div style="cursor:auto;color:#5e6977;font-family:Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;">
                                        <h1 style="font-family: 'Trebuchet MS', Helvetica, Arial, sans-serif; font-size: 28px; font-weight: normal;">
                                            Dear ${user.profile.firstName} ${user.profile.lastName},</h1></div>
                                </td>
                            </tr>
                            <tr>
                                <td style="word-wrap:break-word;font-size:0px;padding:10px 25px;padding-top:0px;padding-bottom:0px;"
                                    align="left">
                                    <div style="cursor:auto;color:#5e6977;font-family:Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;">
                                        <p style="font-size: 15px; margin: 10px 0;">Our team is delighted to welcome you
                                        among our growing number of users.</p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="word-wrap:break-word;font-size:0px;padding:10px 25px;padding-top:20px;padding-bottom:0px;"
                                    align="left">
                                    <div style="cursor:auto;color:#5e6977;font-family:Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;">
                                        <p style="font-size: 15px; margin: 10px 0;">Kind regards,</p>
                                        <p style="font-size: 15px; margin: 10px 0;">CIELO Support Team.</p></div>
                                </td>
                            </tr>
                            <tr>
                                <td style="word-wrap:break-word;font-size:0px;padding:10px 25px;padding-top:20px;"
                                    align="left">
                                        ...
                                        <tr>
                                            <td style="width:80px;">
                                                <img alt="" title="" height="auto"
                                                                         src="http://qrw8.mjt.lu/tplimg/qrw8/b/ogp8/4zo.png"
                                                                         style="border:none;border-radius:0px;display:block;font-size:13px;outline:none;text-decoration:none;width:100%;height:auto;"
                                                                         width="80"/>
                                            </td>
                                            <td style="color: #149dcc !important;;font-weight: 700;white-space: normal;
                                                       vertical-align: -4px;font-style: normal;font-family: 'Rubik', sans-serif;
                            ...
                            <tr>
                                <td style="word-wrap:break-word;font-size:0px;padding:10px 25px;padding-top:0px;padding-bottom:0px;"
                                    align="left">
                                    <div style="cursor:auto;color:#5e6977;font-family:Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;"></div>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        <table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                            ...
                            <tr>
                                <td style="word-wrap:break-word;font-size:0px;padding:0px 20px 0px 20px;padding-top:0px;padding-bottom:0px;"
                                    align="center">
                                    <div style="cursor:auto;color:#5e6977;font-family:Arial, sans-serif;font-size:11px;line-height:22px;text-align:center;">
                                        <p style="font-size: 15px; margin: 10px 0; text-align: -webkit-left;">This e-mail has been sent to
                                        <strong>${user.profile.emailAddress}</strong>. If you have received this email in error, please discard.
                                        </p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td style="word-wrap:break-word;font-size:0px;padding:0px 20px 0px 20px;padding-top:0px;padding-bottom:0px;"
                                    align="center">
                                    <div style="cursor:auto;color:#5e6977;font-family:Arial, sans-serif;font-size:11px;line-height:22px;text-align:center;">
                                        <p style="font-size: 15px; margin: 10px 0;"></p></div>
                                </td>
                            </tr>
                            </tbody>
                        </table>
